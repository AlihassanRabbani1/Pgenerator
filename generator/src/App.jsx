...
function App() {
  ...
  return (
    ...
    <div className="w-full max-w-md mx-auto shadow-md rounded-lg px-4 bg-gray-800 text-orange-500">
      ...
      <h1 className="text-white text-center my-3" style={{fontSize:'2.5rem',}}>Password Genertor</h1>
      ...
      <div className="flex text-sm gap-x-2">
        ...
        <div className="flex items-center gap-x-1">
          <input type="checkbox" id="numberInput" defaultChecked={numberAllowed} onChange={() => { setNumbetAllowed((prev) => !prev) }}  value={password} ref={passwordRef}/>
